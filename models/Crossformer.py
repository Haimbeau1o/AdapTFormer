...
from layers.SelfAttention_Family import AttentionLayer, originalFullAttention, TwoStageAttentionLayer
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(
                    ...
                    AttentionLayer(
                        originalFullAttention(False, configs.factor, attention_dropout=configs.dropout,
